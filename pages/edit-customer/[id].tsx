...
const EditCustomerPage: React.FC = () => {
  ...
  }, [queryError, mutationError, mutationStatus, toast]);
  ...
  return (
    <>
      ...
      {queryStatus === "error" && (
        <p>There was an error retrieving this customer</p>
      )}
      {queryStatus === "success" && (
        <>
          <SimpleGrid
